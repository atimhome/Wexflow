...
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesConcat.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesInfo.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesCopier.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesLoader.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesMover.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesRemover.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ListEntities.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ListFiles.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.MailsSender.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Md5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.MediaInfo.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Mkdir.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ProcessLauncher.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Rmdir.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Sha1.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Sha256.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Sha512.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Touch.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Twitter.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.XmlToCsv.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Xslt.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Zip.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Tar.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Tgz.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Sql.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Wmi.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ImagesTransformer.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Http.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Sync.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Ftp.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesRenamer.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Wait.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesExist.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FileExists.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Movedir.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Now.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Workflow.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.MailsReceiver.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesSplitter.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ProcessKiller.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Unzip.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Untar.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Untgz.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ProcessInfo.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.TextToPdf.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HtmlToPdf.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.SqlToXml.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ImagesCropper.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.CsvToSql.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ImagesConcat.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ImagesOverlay.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Unrar.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.UnSevenZip.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesEncryptor.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FilesDecryptor.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.TextsEncryptor.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.TextsDecryptor.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.DatabaseBackup.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.DatabaseRestore.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.IsoCreator.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.IsoExtractor.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.SevenZip.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.TextToSpeech.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.SpeechToText.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.FileMatch.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.Ping.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.WebToScreenshot.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.WebToHtml.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ExecCs.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ExecVb.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HttpPost.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HttpPut.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HttpPatch.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HttpDelete.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.UglifyJs.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.UglifyCss.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.UglifyHtml.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HtmlToText.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.HttpGet.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.ScssToCss.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.YamlToJson.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.JsonToYaml.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.IfCheck.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.MessageCorrect.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.SwitchCheck.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\x64\Release\Wexflow.Tasks.WhileCheck.dll"; DestDir: "{app}"; Flags: ignoreversion
