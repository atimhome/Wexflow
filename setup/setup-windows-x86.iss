...
Source: "..\src\dotnet\Wexflow.Server\bin\Release\Wexflow.Tasks.IfCheck.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\Release\Wexflow.Tasks.MessageCorrect.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\Release\Wexflow.Tasks.SwitchCheck.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\dotnet\Wexflow.Server\bin\Release\Wexflow.Tasks.WhileCheck.dll"; DestDir: "{app}"; Flags: ignoreversion
